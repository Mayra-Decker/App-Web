...
@section('title', 'Más Opciones: Ejercicios para el Abdomen')

@section('content')
    <div class="container">
        <h1>Más Opciones: Ejercicios para el Abdomen</h1>
        <p>Aquí encontrarás ejercicios adicionales para trabajar y desarrollar los músculos del abdomen.</p>

        <div class="exercise-section">
            <!-- Ejercicio 1: Crunch Abdominal (Crunch) -->
            <div class="exercise">
            ...
            <!-- Ejercicio 2: Elevación de Piernas Colgado (Hanging Leg Raise) -->
            <div class="exercise">
            ...
            <!-- Ejercicio 4: Bicicleta Abdominal (Bicycle Crunch) -->
            <div class="exercise">
            ...
            <!-- Ejercicio 5: Elevación de Rodillas en Paralelas (Captain's Chair Leg Raise) -->
            <div class="exercise">
            ...
            <!-- Ejercicio 6: Ab Wheel Rollout (Rodillo Abdominal) -->
            <div class="exercise">
            ...
            <!-- Ejercicio 7: Crunch Invertido (Reverse Crunch) -->
            <div class="exercise">
    ...
    <!-- Script para manejar la apertura y cierre de los detalles de ejercicios -->
    <script>
