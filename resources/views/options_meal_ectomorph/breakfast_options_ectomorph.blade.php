...
@section('title', 'Opciones de desayuno para ectomorfo')
...
@section('content')
    ...
    <div class="meal-section">
        <h2>Opción 1: Panqueques de avena</h2>
        <ul>
        ...
        <ul>
            ...
            <li>2 tazas de leche o bebida vegetal</li>
            <li>1/2 plátano en rodajas</li>
        ...
        <ul>
            ...
            <li>1 cucharada de proteína en polvo</li>
        ...
        <ul>
            <li>1 taza de yogur griego</li>
            <li>1/2 taza de granola</li>
            <li>1/2 taza de frutas mixtas (fresas, plátano, arándanos)</li>
            <li>Miel al gusto</li>
        ...
        <ul>
            ...
            <li>3 huevos</li>
            <li>50 g de pavo cocido en trozos</li>
            <li>1 taza de espinacas frescas</li>
            <li>Sal y pimienta al gusto</li>
...
<img src="{{ asset('images/breakfast_ectomorph/16.jpg') }}" style="width: 226px; height: auto;">
        ...
        <ul>
            <li>1 tortilla de harina integral</li>
            <li>2 huevos</li>
            <li>1/4 taza de queso rallado</li>
    ...
    <div class="col-md-6">
    <div class="meal-section">
        <h2>Opción 16: Batido de avena y frutas</h2>
        <ul>
            <li>1 taza de avena</li>
            <li>1 plátano</li>
            <li>1 taza de leche o bebida vegetal</li>
