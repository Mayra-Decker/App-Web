...
@section('title', 'Opciones de Pre-entrenamiento para Ectomorfos')

@section('content')
    <div class="intro-section">
        <h1>Opciones de Pre-entrenamiento - Ectomorfo</h1>
        <p>Descubre opciones de comidas rápidas y energéticas para antes de tu entrenamiento como ectomorfo.</p>
    </div>
    
    <div class="row">
    <div class="col-md-6">
    <div class="meal-section">
        <h2>Opción 1: Batido de plátano y mantequilla de maní</h2>
        <ul>
            <li>1 plátano</li>
        ...
        <ul>
            ...
            <li>100 g de pechuga de pollo cocida y en tiras</li>
        ...
        <ul>
            <li>100 g de pechuga de pavo en rodajas</li>
        ...
        <ul>
            <li>2 rebanadas de pan integral</li>
            <li>2 rebanadas de jamón de pavo</li>
    ...
    <div class="col-md-6">
    <div class="meal-section">
        <h2>Opción 16: Wrap de pollo con espinacas</h2>
        <ul>
        ...
        <ul>
            ...
            <li>100 g de pechuga de pollo cocida en cubos</li>
